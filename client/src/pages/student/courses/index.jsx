...
function StudentViewCoursesPage() {
  ...
  function handleFilterOnChange(getSectionId, getCurrentOption) {
    ...
    if (indexOfCurrentSeection === -1) {
      cpyFilters = {
        ...cpyFilters,
        [getSectionId]: [getCurrentOption.label],
      };
      ...
      if (indexOfCurrentOption === -1)
        cpyFilters[getSectionId].push(getCurrentOption.label);
                    ...
                    <Label key={index} className="flex font-medium items-center gap-3">
                      <Checkbox
                        checked={
                          ...
                          filters[ketItem] &&
                          filters[ketItem].indexOf(option.label) > -1
                        }
                        onCheckedChange={() =>
                      ...
                      <p className="text-[16px] text-gray-600 mt-3 mb-2">
                        {`${courseItem?.curriculum?.length} ${
                          courseItem?.curriculum?.length <= 1
                            ? "Lecture"
                            : "Lectures"
                        } - ${courseItem?.level ? courseItem.level.toUpperCase() : 'No Leverl'} Level`}
                      </p>
